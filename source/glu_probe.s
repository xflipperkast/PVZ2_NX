...
purchase_driver_probe:
	...
	.align 2
	.global phase2_state_machine_entry_probe
	.type phase2_state_machine_entry_probe, %function
phase2_state_machine_entry_probe:
	...
	ldr	x0, [sp]
	ldr	x1, [sp, #152]
	bl	phase2_state_machine_entered
	ldp	x0, x1, [sp]
	ldp	x2, x3, [sp, #16]
	ldp	x4, x5, [sp, #32]
	ldp	x6, x7, [sp, #48]
	...
	stp	x20, x19, [sp, #0x60]
	add	x29, sp, #0x50
	adrp	x17, phase2_state_machine_continue
	ldr	x17, [x17, #:lo12:phase2_state_machine_continue]
	br	x17
	.size phase2_state_machine_entry_probe, .-phase2_state_machine_entry_probe

	.align 2
	.global phase2_state70_writer_probe
	.type phase2_state70_writer_probe, %function
phase2_state70_writer_probe:
	...
	mov	x4, x29
	add	x5, sp, #288
	bl	phase2_state70_writer_observed
	...
	str	w21, [x19, #0x70]
	tbz	w20, #0, .Lphase2_writer_branch
	cmp	w8, #3
	b.eq	.Lphase2_writer_branch
	adrp	x17, phase2_state70_writer_continue
	ldr	x17, [x17, #:lo12:phase2_state70_writer_continue]
	br	x17

.Lphase2_writer_branch:
	adrp	x17, phase2_state70_writer_branch_target
	ldr	x17, [x17, #:lo12:phase2_state70_writer_branch_target]
	br	x17
	.size phase2_state70_writer_probe, .-phase2_state70_writer_probe
	...
	.align 2
	.global phase2_dispatch_return_probe
	.type phase2_dispatch_return_probe, %function
phase2_dispatch_return_probe:
	sub	sp, sp, #288
	stp	x0, x1, [sp]
	stp	x2, x3, [sp, #16]
	stp	x4, x5, [sp, #32]
	...
	add	x3, sp, #288
	ldr	x4, [sp, #152]
	bl	phase2_request_dispatch_returned
	ldp	x0, x1, [sp]
	ldp	x2, x3, [sp, #16]
	ldp	x4, x5, [sp, #32]
	ldp	x6, x7, [sp, #48]
	...
	ldr	x20, [sp, #0x88]
	adrp	x8, phase2_dispatch_adrp_value
	ldr	x8, [x8, #:lo12:phase2_dispatch_adrp_value]
	add	x8, x8, #0xdb8
	str	x8, [sp, #0x78]
	adrp	x17, phase2_dispatch_return_continue
	ldr	x17, [x17, #:lo12:phase2_dispatch_return_continue]
	br	x17
	.size phase2_dispatch_return_probe, .-phase2_dispatch_return_probe
	...
	.align 2
	.global phase2_nimble_request_call_probe
	.type phase2_nimble_request_call_probe, %function
phase2_nimble_request_call_probe:
	sub	sp, sp, #288
	stp	x0, x1, [sp]
	stp	x2, x3, [sp, #16]
	stp	x4, x5, [sp, #32]
	...
	mov	x5, x29
	add	x6, sp, #288
	bl	phase2_nimble_request_adapter_entered
	ldp	x0, x1, [sp]
	ldp	x2, x3, [sp, #16]
	ldp	x4, x5, [sp, #32]
	ldp	x6, x7, [sp, #48]
	...
	add	x2, sp, #0x50
	add	x3, sp, #0x38
	adrp	x30, phase2_nimble_request_return
	ldr	x30, [x30, #:lo12:phase2_nimble_request_return]
	adrp	x17, phase2_nimble_request_adapter
	ldr	x17, [x17, #:lo12:phase2_nimble_request_adapter]
	br	x17
	.size phase2_nimble_request_call_probe, .-phase2_nimble_request_call_probe
...
1:
	...
	/* The Arena maintenance/status lookup at +0x1DA8450 returns an object
	 * whose string field lives at +0x40.  A missing live-event record produces
	 * a null result, which stock code dereferences immediately.  The generic
	 * hook replaces four instructions, so replay the original lookup and setup
	 * before joining the unchanged libc++ string-copy call. */
	.align 2
	.global arena_status_object_guard_probe
	.type arena_status_object_guard_probe, %function
arena_status_object_guard_probe:
	adrp	x17, arena_status_lookup
	ldr	x17, [x17, #:lo12:arena_status_lookup]
	blr	x17
	cbz	x0, 1f
	tbz	w20, #0, 1f
	add	x1, x0, #0x40
	mov	x0, sp
	adrp	x17, arena_status_string_copy
	ldr	x17, [x17, #:lo12:arena_status_string_copy]
	br	x17
1:
	adrp	x17, arena_status_unavailable_target
	ldr	x17, [x17, #:lo12:arena_status_unavailable_target]
	br	x17
	.size arena_status_object_guard_probe, .-arena_status_object_guard_probe

	.align 2
	.global phase2_request_state2_probe
	.type phase2_request_state2_probe, %function
phase2_request_state2_probe:
	sub	sp, sp, #288
	stp	x0, x1, [sp]
	stp	x2, x3, [sp, #16]
	stp	x4, x5, [sp, #32]
	...
	add	x4, sp, #288
	ldr	x5, [sp, #152]
	bl	phase2_request_lifecycle_observed
	ldp	x0, x1, [sp]
	ldp	x2, x3, [sp, #16]
	ldp	x4, x5, [sp, #32]
	ldp	x6, x7, [sp, #48]
	...
	ldp	x28, x8, [x1, #0x18]
	cmp	x28, x8
	adrp	x17, phase2_request_state2_continue
	ldr	x17, [x17, #:lo12:phase2_request_state2_continue]
	br	x17
	.size phase2_request_state2_probe, .-phase2_request_state2_probe

	.align 2
	.global phase2_request_state5_probe
	.type phase2_request_state5_probe, %function
phase2_request_state5_probe:
	sub	sp, sp, #288
	stp	x0, x1, [sp]
	stp	x2, x3, [sp, #16]
	stp	x4, x5, [sp, #32]
	...
	ldur	x23, [x29, #-0x88]
	mov	x0, x23
	adrp	x30, phase2_request_state5_continue
	ldr	x30, [x30, #:lo12:phase2_request_state5_continue]
	adrp	x17, phase2_request_state5_helper
	ldr	x17, [x17, #:lo12:phase2_request_state5_helper]
	br	x17
	.size phase2_request_state5_probe, .-phase2_request_state5_probe

	.align 2
	.global phase2_request_state6_probe
	.type phase2_request_state6_probe, %function
phase2_request_state6_probe:
	sub	sp, sp, #288
	stp	x0, x1, [sp]
	stp	x2, x3, [sp, #16]
	stp	x4, x5, [sp, #32]
	...
	ldr	x8, [x20]
	ldr	x8, [x8, #0x18]
	adrp	x17, phase2_request_state6_continue
	ldr	x17, [x17, #:lo12:phase2_request_state6_continue]
	br	x17
	.size phase2_request_state6_probe, .-phase2_request_state6_probe

	.align 2
	.global phase2_request_state4_probe
	.type phase2_request_state4_probe, %function
phase2_request_state4_probe:
	sub	sp, sp, #288
	stp	x0, x1, [sp]
	stp	x2, x3, [sp, #16]
	stp	x4, x5, [sp, #32]
	...
	ldr	x8, [x20]
	ldr	x8, [x8, #0x18]
	adrp	x17, phase2_request_state4_continue
	ldr	x17, [x17, #:lo12:phase2_request_state4_continue]
	br	x17
	.size phase2_request_state4_probe, .-phase2_request_state4_probe

	.align 2
	.global phase2_request_state3_probe
	.type phase2_request_state3_probe, %function
phase2_request_state3_probe:
	sub	sp, sp, #288
	stp	x0, x1, [sp]
	stp	x2, x3, [sp, #16]
	stp	x4, x5, [sp, #32]
	...
	str	w8, [x27, #0x70]
	ldur	x20, [x29, #-0x60]
	cbz	x20, .Lphase2_state3_branch
	add	x1, x20, #0x8
	adrp	x17, phase2_request_state3_continue
	ldr	x17, [x17, #:lo12:phase2_request_state3_continue]
	br	x17
.Lphase2_state3_branch:
	adrp	x17, phase2_request_state3_branch
	ldr	x17, [x17, #:lo12:phase2_request_state3_branch]
	br	x17
	.size phase2_request_state3_probe, .-phase2_request_state3_probe
